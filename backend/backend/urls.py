...
urlpatterns = [
    ...
    # Include app routes (assuming 'users' is the app for user, product, compra, pedido management)
    path('api/users/', include('users.urls')),  # Users-related endpoints (products, compras, pedidos, etc.)
]
